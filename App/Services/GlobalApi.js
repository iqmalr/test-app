...
const loginApi = (email, password) =>
  AxiosInstance.get(
    "/pasiens?filters[Email][$eq]=" +
      email +
      "&filters[Password][$eq]=" +
      password
  );
const registerApi = (data) => AxiosInstance.post("/pasiens", data);
const getUserData = (email) =>
  AxiosInstance.get("/pasiens?filters[Email][$eq]=" + email);
const editUserData = (id, data) => AxiosInstance.put("/pasiens/" + id, data);
